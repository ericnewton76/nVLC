...
namespace LibVlcWrapper
{
    ...
    public static class LibVlcMethods
    {
        ...
        #else
        private const string libvlc = "libvlc.so.5";
        #endif
        ...
        [DllImport(libvlc, CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_media_player_set_xwindow(IntPtr p_mi, IntPtr drawable);

        [DllImport(libvlc, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr libvlc_media_player_get_xwindow(IntPtr p_mi);
